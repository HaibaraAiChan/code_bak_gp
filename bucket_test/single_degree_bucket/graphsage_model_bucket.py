...
class SAGEConv(nn.Module):
	...
	def forward(self, graph, feat, degree):
		...
		# h_neigh = graph.dstdata['neigh']
			...
			graph.update_all(msg_fn, self._lstm_reducer, degree=degree) #==========================
...
class GraphSAGE(nn.Module):
	...
	def forward(self, blocks, x, degree):
		...
		x = self.layers[-1](blocks[-1], x, degree)
